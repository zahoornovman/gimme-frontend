      ...
      {userFirstName === "NoNa" ? (
        ...
        <div className="created fontSize">
          ...
          <div className="createdButtons">
            ...
            <TextButton className="fontSize" onClick={() => navigate("/")}>
              Home
            </TextButton>
          </div>
        </div>
        ...
        <div className="error fontSize">
          <div>
            Unfortunately, an error has occured. Please contact our backoffice.
          </div>
          <TextButton
            className="fontSize"
        ...
        <div className="requestContentSection">
          <Header2 className="fontSize">What do you like to receive?</Header2>
          {message === "fileQuantityError" ? (
            ...
            <div className="fontSize">
              ...
              } MB. Please remove all files exceeding ${
                maxImageFileSize / 1024 / 1024
              } MB. 😉`}
            </div>
          ) : message === "noImageSelected" || message === "noImageChoosen" ? (
            <div className="fontSize">{`Offers require an image. 😉`}</div>
          ) : message === "imageAndFieldsNotCompleted" ? (
            <div className="fontSize">
              Please upload at least 1 image and fill in all fields. 😉
            </div>
          ) : message === "FieldsNotCompleted" ? (
            <div className="fontSize">Please fill in all fields. 😉</div>
          ) : (
            <></>
          )}
          <div className="inputField">
            <label className="fontSize" htmlFor="title">
              Title:
            </label>
            <input
              className="fontSize"
          ...
          <div className="inputField">
            <label className="fontSize" htmlFor="description">
              Description:
            </label>
            <input
              className="fontSize"
          ...
          <div className="inputField">
            <label className="fontSize" htmlFor="condition">
              Condition:
            </label>

            <select id="condition">
              <option value="1" className="fontSize">
                New
              </option>
              <option value="2" className="fontSize">
                Used like new
              </option>
              <option value="3" className="fontSize">
                Used good
              </option>
              <option value="4" className="fontSize">
                Used fair
              </option>
            </select>
          </div>
          <div className="inputField">
            <label className="fontSize" htmlFor="offer">
              Offered:
            </label>
            <input
              className="fontSize"
          ...
          <div className="inputField">
            <label className="fontSize" htmlFor="tags">
              Tag:
            </label>
          ...
          <div className="inputField">
            <label className="fontSize" htmlFor="images">
              Images(s):
            </label>
            <input
              className="fontSize"
          ...
          <TextButton className="fontSize" onClick={handleSave}>
            Save
          </TextButton>
        </div>
      )}
