            ...
            <div className="notLoading">
              <div className="latestOfferContainer">
                ...
                {fetchingStatus === 'error' ? (
                  <div>Latest offers can't be displayed at the moment. We apologise for the inconvenience. 😖</div>
                ) : (
            ...
            <div className="overlayer">
              <PopUp className="popUpWelcomePage">
                <div className="fontSize">
                  Do you agree with the <Link to={'../admin/termsofuse'}>terms of use</Link> and with usage of cookies?
                </div>
                <div>
              ...
              {searchStatus === 'match' ? (
                <div className="searchMatch">
                  ...
                  <div className="searchResultButtons">
                    <TextButton onClick={handleNewSearchDismissSearchResults}>New search</TextButton>
                    <TextButton onClick={handleNewSearchDismissSearchResults}>Discard search results</TextButton>
                    <TextButton onClick={handleClickedAllOffers}>All offers</TextButton>
                    <TextButton onClick={handleClickedAllRequests}>All requets</TextButton>
                  </div>
                </div>
              ) : (
                <>
                  <div className="searchContainer">
                    ...
                    {searchStatus === 'noKeyWordGiven' ? (
                      <div>Please enter a key word and click on the search button afterwards. 😜</div>
                    ) : searchStatus === 'error' ? (
                      <div>
                        Search is currently out of service. We apologise for the inconvenience. 🙄 Please try again
                        later.
                      </div>
