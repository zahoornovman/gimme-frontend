                            ...
                            searchStatus === "match"
                                ...
                                <div className="searchMatch">
                                    ...
                                    <div className="searchResultButtons">
                                        <TextButton
                                            onClick={handleNewSearchDismissSearchResults}
                                        >New search</TextButton>
                                        <TextButton
                                            onClick={handleNewSearchDismissSearchResults}
                                        >Discard search results</TextButton>
                                        <TextButton
                                            onClick={handleClickedAllOffers}
                                        >All offers</TextButton>
                                        <TextButton
                                            onClick={handleClickedAllRequests}
                                        >All requets</TextButton>
                                    </div>
                                </div>
                                :
                                <>
                                    <div className="searchContainer">
                                        <Header2>Search</Header2>
                                        {
                                            searchStatus === "noKeyWordGiven"
                                                ...
                                                searchStatus === "error"
                                                    ?
                                                    <div>Search is currently out of service. We apologise for the inconvenience. 🙄 Please try again later.</div>
                                                    :
                                        ...
                                        <div>
                                            <label
                                                className="fontSize"
                                                htmlFor="searchKeyWords">Key words</label>
                                            <input
                                        ...
                                        <div>
                                            <label
                                                className="fontSize"
                                                htmlFor="searchIn">Search in</label>
                                            <select
                                                id="searchIn">
                                                <option
                                                    className="fontSize"
                                                ...
                                                <option
                                                    className="fontSize"
                                                    value="requests">requests</option>
                                            </select>
                                        </div>
                                        <TextButton
                                            className="fontSize"
                    ...
                    <div className="overlayer">
                        <PopUp className="popUpWelcomePage">
                            ...
                            <div>
                                ...
                                >Yes, I do.</PopUpButtonYes>
                                <PopUpButtonNo
                                className="fontSize"
                                onClick={
                                    handleDisagreement
                                }>No, I don't.</PopUpButtonNo>
                            </div>
                        </PopUp>
                    </div>
                    :
