        ...
        <SignUpContainer>
            ...
            >
                ...
                <div className="inputSignUp">
                {
                    ...
                    ?
                    <div 
                    className="messageSignUp fontSize">
                    ...
                    <div className="termsOfUseAcceptance">
                        <div
                            className="fontSize">Do you agree with the <Link to={"../admin/termsofuse"}>terms of use</Link>?</div>
                        <div className="termsOfUSeSelection">
                            <input className="fontSize" type="radio" id="agree" name="termsOfUse" value="yes" />
                            <label className="fontSize" for="agree">Yes</label>

                            <input className="fontSize" type="radio" id="disagree" name="termsOfUse" value="no" defaultChecked />
                            <label className="fontSize" for="disagree">No</label>
                        </div>
