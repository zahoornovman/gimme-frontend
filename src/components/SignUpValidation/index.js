...
import { Header2, PopUp, PopUpButtonNo, PopUpButtonYes, TextButton, TextContainer } from "../../styles/MasterStyles";
...
function SignUpValidation() {
    ...
    const handleCompleteSignUp = () => {
        ...
        if (password === passwordRepeat) {
            if (password === "" || passwordRepeat === "" || username === "" || email === "" || firstName === "" || lastName === "" || location === "" || validationCode === "") {
    ...
    return (
        <ContainerSignUpValidation>
            ...
            <Header2
                className="fontSize"
            >Just a step a head from swaping!</Header2>
